...
<div class="form__col aegis-question-form__row2-col1">
<div class="form__field-container">
<input type="text" class="form__input-text" placeholder="Mobile No" required id="mobileno" name="mobileno">
<div class="form__validation">Validation</div>
</div>
</div>
</div>
...
<textarea class="form__input-textarea" name="message" id="message" cols="30" rows="5" placeholder="Message"></textarea>
</div>
</div>

<div class="form__submit-wrapper">
<button class="form__submit btn1" type="submit" name="btnsend" id="btnsend" onclick="submitEnquiry();">Submit</button>
</div>
