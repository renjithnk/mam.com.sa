...
<div class="site-content subpage-content landing-page">
    ...
    <div class="site-content__section landing-page-banner">
        ...
        <?php
  	$landingpagesliderSql = "SELECT * FROM landingpageslider where  page_id=3 and status=0";
...
?>
        ...
        <div class="landing-page-banner__col2">
            <?php include('forms/international-movers-form.php') ?>
        </div>
    </div>


    <?php
$streefreemoveSql = "SELECT * FROM streefreemove where page_id=3 and status=0";
$db = new Database();
...
?>
    ...
    <div class="site-content__section landing-page-services no-padding-bottom no-padding-top">
        <div class="landing-page-services__container container">
            ...
            <div class="landing-page-services__items-container">
                ...
                <?php
	$serviceSql = "SELECT * FROM landingpagesservice where page_id=3 and status=0";
	...
	?>
        ...
        <?php
$whychooseusSql = "SELECT * FROM whychooseus where page_id=3 and status=0";
$db = new Database();
        ...
        <div class="aegis-testimonials__container container">
            ...
            <div class="swiper2 aegis-testimonials__swiper2">
                <div class="swiper-wrapper aegis-testimonials__wrapper">
                    <?php
				$sql = "SELECT * FROM landingpagestestimonial where page_id=3 and status=0 order by id desc";
				$result = $db->query($sql);
