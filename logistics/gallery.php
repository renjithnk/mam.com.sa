...
<div class="site-content subpage-content about-us">
    ...
    <div class="site-content__section subpage-banner">
        <img src="../logistics/assets/images/gallery-banner.webp" alt="" class="subpage-banner__img">
        <h1 class="subpage-banner__heading">Gallery</h1>
    </div>
    ...
    <div class="site-content__section subpage-main-content">
        <div class="subpage-content__section subpage-main-content__single-column-container container-fluid">
		...
		?>
				...
				while ($row = $result->fetch_array()) 
				{
						 if($row["image"] != "")
						 {
						 	$galleryImgPath=$clientPath . "/admin/uploads/gallery/" . $row["image"];
						 }
				?>
                    <li>
                        <a href="<?php echo $galleryImgPath;?>" data-lightbox="example-set">
                            <img src="<?php echo $galleryImgPath;?>" alt="<?php echo $row["alt"];?>" /></a>
                    </li>
                    <?php
				}
				?>
...
(function(root, factory) {
    ...
    Lightbox.prototype.changeImage = function(imageNumber) {
        ...
        preloader.onload = function() {
            ...
            if (self.options.fitImagesInViewport) {
                ...
                maxImageWidth = windowWidth - self.containerPadding.left - self.containerPadding.right -
                    self.imageBorderWidth.left - self.imageBorderWidth.right - 20;
                maxImageHeight = windowHeight - self.containerPadding.top - self.containerPadding
                    .bottom - self.imageBorderWidth.top - self.imageBorderWidth.bottom - 120;
    ...
    Lightbox.prototype.sizeContainer = function(imageWidth, imageHeight) {
        ...
        var newWidth = imageWidth + this.containerPadding.left + this.containerPadding.right + this
            .imageBorderWidth.left + this.imageBorderWidth.right;
        var newHeight = imageHeight + this.containerPadding.top + this.containerPadding.bottom + this
            .imageBorderWidth.top + this.imageBorderWidth.bottom;
