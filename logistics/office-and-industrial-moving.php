...
$sql = "SELECT * FROM service where id=5 and status=0";
$db = new Database();
$result = $db->query($sql);
...
$faqSql="select * from faq where service_id=5 and status=0";
...
<div class="site-content subpage-content about-us">
    ...
    <div class="site-content__section subpage-main-content">
	 ...
	 echo $row['description'];?>
                ...
                <?php
			$landingpagevideoSql = "SELECT * FROM videos where service_id=5 and status=0";
            ...
            <div class="aegis-testimonials__container container-fluid">
                ...
                <div class="swiper2 aegis-testimonials__swiper2">
                    <div class="swiper-wrapper aegis-testimonials__wrapper">
                        <?php
				$sql = "SELECT * FROM service_pages_testimonial where service_id=5 and status=0 order by id desc";
				$result = $db->query($sql);
				if(@$result->num_rows > 0) 
				{
						$sliderPath="";
