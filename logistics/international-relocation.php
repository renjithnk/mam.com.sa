...
$sql = "SELECT * FROM service where id=11 and status=0";
$db = new Database();
$result = $db->query($sql);
...
$faqSql="select * from faq where service_id=11 and status=0";
    ...
    <div class="site-content__section subpage-main-content">
        <div class="subpage-content__section subpage-main-content__double-column-container">
		  ...
		  echo $row['description'];?>
                ...
                <?php
			$landingpagevideoSql = "SELECT * FROM videos where service_id=11 and status=0";
