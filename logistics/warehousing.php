...
$sql = "SELECT * FROM service where id=2 and status=0";
$db = new Database();
$result = $db->query($sql);
...
$faqSql="select * from faq where service_id=2 and status=0";
        ...
        <div class="subpage-content__section subpage-main-content__double-column-container">
		 ...
		 echo $row['description'];?>
                    ...
                    <div class="contact-us-subpage-box">
                        <div class="contact-us-subpage-box__label">Call for Enquiries: </div>
                        <a href="tel:<?php echo $aegisSettingsResultRow['contactno2'];?>"
                ...
                <?php
		$landingpagevideoSql = "SELECT * FROM videos where service_id=2 and status=0";
            ...
            <div class="aegis-testimonials__container container-fluid">
                ...
                <div class="swiper2 aegis-testimonials__swiper2">
                    <div class="swiper-wrapper aegis-testimonials__wrapper">
                        <?php
				$sql = "SELECT * FROM service_pages_testimonial where service_id=2 and status=0 order by id desc";
				$result = $db->query($sql);
				if(@$result->num_rows > 0) 
				{
						$sliderPath="";
