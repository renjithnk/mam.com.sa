...
{ */
			...
			if($msg == "")
			{
							...
							$sql = "INSERT INTO international_movers (name, email, country_code, phoneno, moving_from_country, moving_to_country, estimated_date) VALUES ('$name', '$email', '$country_code', '$phoneno','$moving_from_country','$moving_to_country','$estimated_date')";
							$db->query($sql);
							...
							$message = "
								<html>
								<head>
									<title>International Movers</title>
										</head>
										<body>
										<p>International Movers from: https://mam.com.sa/logistics</p>
