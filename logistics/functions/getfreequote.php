...
{ */
			...
			if($msg == "")
			{
							...
							$sql = "INSERT INTO quote_requests (name, email, phoneno, moving_from_country,moving_to_country,estimated_date) VALUES ('$name', '$email', '$phoneno','$moving_from_country','$moving_to_country','$estimated_date')";
							$db->query($sql);
							...
							$message = "
								...
								<head>
									<title>Request A Quote</title>
										...
										<body>
										<p>Request A Quote from: https://mam.com.sa/logistics</p>
