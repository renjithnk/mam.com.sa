...
<div class="admin-main-section dashboard">
		<h1 class="admin-main-section__heading">Add Sea Freight</h1>
		...
		<div class="href_back"><a href="<?php echo $adminPath;?>seafreightbrief/list.php" class="btn-default">Back</a></div>
					<div id="msg"></div>
						<form name="frmaddseafreight" id="frmaddseafreight" method="post" enctype="multipart/form-data">
							<table style="padding: 0; margin: 0;">
								...
								<tr>	
									...
									<button class="form__submit btn1" type="submit" name="btnseafreightadd" id="btnseafreightadd" onclick="submitSeaFreight();">Submit</button>
									</td>
								</tr>
							</table>
