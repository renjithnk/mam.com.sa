...
if(@$_POST['add']=="add")
{
	...
	$uploadedFile='';
	$uploadDir =  "../uploads/aboutbrief/";  // Specify the directory where you want to store uploaded files
	...
	/*$sql = "INSERT INTO about_brief (caption, description, image,alt, icon_image1, icon_image1_alt,icon_image1_description,icon_image2,icon_image2_alt,icon_image2_description,icon_image3, icon_image3_alt,icon_image3_description) VALUES ('$caption', '$description', '$uploadedFile','$alt', '$icon_image1', '$icon_image1_alt','$icon_image1_description','$icon_image2','$icon_image2_alt','$icon_image2_description','$icon_image3', '$icon_image3_alt','$icon_image3_description')";*/
...
if(@$_POST["update"] == 'update')
{
	...
	if($id != "")
	{
		...
		$sql = "UPDATE 	about_brief set caption='$caption',description='$description', alt='$alt',icon_image1_alt='$icon_image1_alt',
...
if(@$_POST["delete"] == 'delete')
{
	...
	if($id != "")
	{
		$sql = "UPDATE about_brief set status=2 where id=$id";
		$db->query($sql);
