...
<div class="admin-main-section dashboard">
		<h1 class="admin-main-section__heading">Add Why Choose Us</h1>
		...
		<div class="href_back"><a href="<?php echo $adminPath;?>whychooseus/list.php" class="btn-default">Back</a></div>
					...
					<div id="msg"></div>
<form name="frmaddwhychooseus" id="frmaddwhychooseus" method="post" enctype="multipart/form-data">
	<table style="padding: 0; margin: 0;">
		...
		<tr>
			...
			<button class="form__submit btn1" type="submit" name="btnWhyChooseUsAdd" id="btnWhyChooseUsAdd" onclick="submitWhyChooseUs();">Submit</button></td>
		</tr>
