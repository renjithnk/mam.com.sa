...
<div class="admin-main-section dashboard">
		<h1 class="admin-main-section__heading">Add Our Service</h1>
		...
		<div class="href_back"><a href="<?php echo $adminPath;?>ourservice/list.php" class="btn-default">Back</a></div>
					...
					<div id="msg"></div>
<form name="frmaddourservice" id="frmaddourservice" method="post" enctype="multipart/form-data">
	<table style="padding: 0; margin: 0;">
		...
		<tr>
			<td>Ads Image</td>
			<td><input type="file" id="ads_image" name="ads_image" required></td>
		</tr>
		<tr>
			<td>Ads Image Alt</td>
			<td><input type="text" id="ads_image_alt" name="ads_image_alt" class="cls_txt" required></td>
		</tr>
		<tr>
			<td colspan="2" style="text-align:center;">
			<button class="form__submit btn1" type="submit" name="btnOurserviceAdd" id="btnOurserviceAdd" onclick="submitOurservice();">Submit</button></td>
		</tr>
