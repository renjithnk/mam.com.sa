	...
	<div class="admin-main-section__content">
		...
		<form name="frmlistenquiry" id="frmlistenquiry" method="post" enctype="multipart/form-data">
			<div class="table-wrapper">
				<table style="padding: 0; margin: 0;" class="enquiries-table">
					<tr>
						<th>Name</th>
						<th>Email</th>
						<th>Mobileno</th>
					...
					if (@$result->num_rows > 0) {
						...
						while ($row = $result->fetch_array()) {
							...
							<tr>
								...
								<td>
									<input type="button" class="form__submit btn2" id="btnEnquiryDelete" name="btnEnquiryDelete"
										value="Delete" onclick="deleteEnquiry(<?php echo $row["id"]; ?>)">
								</td>
							</tr>
							<?php
						}
