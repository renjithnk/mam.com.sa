...
var frmaddaboutusExists = document.getElementById("frmaddaboutus");
if(frmaddaboutusExists)
{
		document.getElementById('frmaddaboutus').onsubmit=function(e){
					/*const description = CKEDITOR.instances.description.getData();*/
					const description = document.getElementById("description").value;
					if(description != "")
					{
							...
							var url="../php/aboutus.php";
							xhr.open('post',url,true);
							var formData=new FormData(frmaddaboutus);
...
var frmeditaboutusExists = document.getElementById("frmeditaboutus");
if(frmeditaboutusExists)
{
		document.getElementById('frmeditaboutus').onsubmit=function(e){
					/*const description = CKEDITOR.instances.description.getData();*/
					const description = document.getElementById("description").value;
					if(description != "")
					{
									...
									var url="../php/aboutus.php";
									xhr.open('post',url,true);
									var formData=new FormData(frmeditaboutus);
									formData.append("description", description);
...
function deleteAboutus(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/aboutus.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistaboutus);
