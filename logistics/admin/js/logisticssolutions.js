...
function submitLogisticsSolutions()
{
...
var frmaddlogisticssolutionsExists = document.getElementById("frmaddlogisticssolutions");
if(frmaddlogisticssolutionsExists)
{
		document.getElementById('frmaddlogisticssolutions').onsubmit=function(e){
						e.preventDefault();
						var xhr=new XMLHttpRequest();
						var url="../php/logisticssolutions.php";
						xhr.open('post',url,true);
						var formData=new FormData(frmaddlogisticssolutions);
...
function editLogisticsSolutions(id)
{
	 window.location.href="edit.php?id="+id;
}


function submitUpdateLogisticsSolutions()
{
		document.getElementById("errmsg").innerHTML="";
		document.getElementById("loading").style.display = "none";
		document.getElementById("msgstatus").style.display = "none";
...
var frmeditlogisticssolutionsExists = document.getElementById("frmeditlogisticssolutions");
if(frmeditlogisticssolutionsExists)
{
		document.getElementById('frmeditlogisticssolutions').onsubmit=function(e){
					e.preventDefault();
					var xhr=new XMLHttpRequest();
					var url="../php/logisticssolutions.php";
					xhr.open('post',url,true);
					var formData=new FormData(frmeditlogisticssolutions);
...
function deleteLogisticsSolutions(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/logisticssolutions.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistlogisticssolutions);
