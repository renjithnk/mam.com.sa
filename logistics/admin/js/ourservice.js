...
var frmaddourserviceExists = document.getElementById("frmaddourservice");
if(frmaddourserviceExists)
{
		document.getElementById('frmaddourservice').onsubmit=function(e){
					/*const description = CKEDITOR.instances.description.getData();*/
					const description = document.getElementById("description").value;
					if(description != "")
					{
							...
							var url="../php/ourservice.php";
							xhr.open('post',url,true);
							var formData=new FormData(frmaddourservice);
...
function editOurservice(id)
{
	 window.location.href="edit.php?id="+id;
}


function submitEditOurservice()
{
		/*const description = CKEDITOR.instances.description.getData();*/
		const description = document.getElementById("description").value;
		document.getElementById("errmsg").innerHTML="";
...
var frmeditourserviceExists = document.getElementById("frmeditourservice");
if(frmeditourserviceExists)
{
		document.getElementById('frmeditourservice').onsubmit=function(e){
					/*const description = CKEDITOR.instances.description.getData();*/
					const description = document.getElementById("description").value;
					if(description != "")
					{
									...
									var url="../php/ourservice.php";
									xhr.open('post',url,true);
									var formData=new FormData(frmeditourservice);
									formData.append("description", description);
...
function deleteOurservice(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/ourservice.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistourservice);
