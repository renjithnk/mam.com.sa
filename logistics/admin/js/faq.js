...
var frmaddfaqExists = document.getElementById("frmaddfaq");
if(frmaddfaqExists)
{
		document.getElementById('frmaddfaq').onsubmit=function(e){
					/*const description = CKEDITOR.instances.description.getData();*/
					const description = document.getElementById("description").value;
					if(description != "")
					{
							...
							var formData=new FormData(frmaddfaq);
...
var frmeditfaqExists = document.getElementById("frmeditfaq");
if(frmeditfaqExists)
{
		document.getElementById('frmeditfaq').onsubmit=function(e){
					/*const description = CKEDITOR.instances.description.getData();*/
					const description = document.getElementById("description").value;
					if(description != "")
					{
									...
									var url="../php/faq.php";
									xhr.open('post',url,true);
									var formData=new FormData(frmeditfaq);
									formData.append("description", description);
...
function deleteFaq(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/faq.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistfaq);
