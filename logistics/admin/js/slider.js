...
var frmaddsliderExists = document.getElementById("frmaddslider");
if(frmaddsliderExists)
{
		document.getElementById('frmaddslider').onsubmit=function(e){
						e.preventDefault();
						var xhr=new XMLHttpRequest();
						var url="../php/slider.php";
						xhr.open('post',url,true);
						var formData=new FormData(frmaddslider);
...
var frmeditsliderExists = document.getElementById("frmeditslider");
if(frmeditsliderExists)
{
		document.getElementById('frmeditslider').onsubmit=function(e){
					e.preventDefault();
					var xhr=new XMLHttpRequest();
					var url="../php/slider.php";
					xhr.open('post',url,true);
					var formData=new FormData(frmeditslider);
...
function deleteSlider(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/slider.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistslider);
