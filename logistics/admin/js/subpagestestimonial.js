...
function submitSubPagesTestimonial()
{
...
var frmaddsubpagestestimonialExists = document.getElementById("frmaddsubpagestestimonial");
if(frmaddsubpagestestimonialExists)
{
		document.getElementById('frmaddsubpagestestimonial').onsubmit=function(e){
					...
					if(comment != "")
					{
							...
							var url="../php/subPagestestimonial.php";
							xhr.open('post',url,true);
							var formData=new FormData(frmaddsubpagestestimonial);
...
function editSubPagesTestimonial(id)
{
	 window.location.href="edit.php?id="+id;
}


function submitEditSubpagesTestimonial()
{
		/*const comment = CKEDITOR.instances.comment.getData();*/
		const comment = document.getElementById("comment").value;
		document.getElementById("errmsg").innerHTML="";
...
var frmeditsubpagestestimonialExists = document.getElementById("frmeditsubpagestestimonial");
if(frmeditsubpagestestimonialExists)
{
		document.getElementById('frmeditsubpagestestimonial').onsubmit=function(e){
					/*const comment = CKEDITOR.instances.comment.getData();*/
					const comment = document.getElementById("comment").value;
					if(comment != "")
					{
									...
									var url="../php/subpagestestimonial.php";
									xhr.open('post',url,true);
									var formData=new FormData(frmeditsubpagestestimonial);
									formData.append("comment", comment);
									...
									if(this.response == "Updated successfully.")
									{
										...
										document.getElementById("msgstatus").innerHTML=this.response;
										const submittedFormId = e.target.id;
									//	frmeditsubpagestestimonial.reset();
										clearForm(submittedFormId);
										setTimeout(()=>{
											document.getElementById("msgstatus").style.display = "none";
										},4000)
...
function deleteSubPagesTestimonial(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/subpagestestimonial.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistsubpagestestimonial);
