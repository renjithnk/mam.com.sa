...
function submitGallery()
{
		...
		if((document.getElementById("image").value == "") && (document.getElementById("image").src == ""))
		{
...
var frmaddgalleryExists = document.getElementById("frmaddgallery");
if(frmaddgalleryExists)
{
				document.getElementById('frmaddgallery').onsubmit=function(e){
				e.preventDefault();
				var xhr=new XMLHttpRequest();
				var url="../php/gallery.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmaddgallery);
...
var frmeditgalleryExists = document.getElementById("frmeditgallery");
if(frmeditgalleryExists)
{
				document.getElementById('frmeditgallery').onsubmit=function(e){
				e.preventDefault();
				var xhr=new XMLHttpRequest();
				var url="../php/gallery.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmeditgallery);
...
function deleteGallery(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/gallery.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistgallery);
