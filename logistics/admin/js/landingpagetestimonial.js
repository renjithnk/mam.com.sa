...
var frmaddtestimonialExists = document.getElementById("frmaddtestimonial");
if(frmaddtestimonialExists)
{
		document.getElementById('frmaddtestimonial').onsubmit=function(e){
					...
					if(comment != "")
					{
							...
							var url="../php/landingpagetestimonial.php";
							xhr.open('post',url,true);
							var formData=new FormData(frmaddtestimonial);
...
var frmedittestimonialExists = document.getElementById("frmedittestimonial");
if(frmedittestimonialExists)
{
		document.getElementById('frmedittestimonial').onsubmit=function(e){
					/*const comment = CKEDITOR.instances.comment.getData();*/
					const comment = document.getElementById("comment").value;
					if(comment != "")
					{
									...
									var url="../php/landingpagetestimonial.php";
									xhr.open('post',url,true);
									var formData=new FormData(frmedittestimonial);
									formData.append("comment", comment);
...
function deleteTestimonial(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/landingpagetestimonial.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlisttestimonial);
