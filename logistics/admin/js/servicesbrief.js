...
var frmaddservicesbriefExists = document.getElementById("frmaddservicesbrief");
if(frmaddservicesbriefExists)
{
		document.getElementById('frmaddservicesbrief').onsubmit=function(e){
						e.preventDefault();
						var xhr=new XMLHttpRequest();
						var url="../php/servicesbrief.php";
						xhr.open('post',url,true);
						var formData=new FormData(frmaddservicesbrief);
...
function editServicesBrief(id)
{
	 window.location.href="edit.php?id="+id;
}


function submitUpdateServicesBrief()
{
		document.getElementById("errmsg").innerHTML="";
		document.getElementById("loading").style.display = "none";
		document.getElementById("msgstatus").style.display = "none";
...
var frmeditservicesbriefExists = document.getElementById("frmeditservicesbrief");
if(frmeditservicesbriefExists)
{
		document.getElementById('frmeditservicesbrief').onsubmit=function(e){
					e.preventDefault();
					var xhr=new XMLHttpRequest();
					var url="../php/servicesbrief.php";
					xhr.open('post',url,true);
					var formData=new FormData(frmeditservicesbrief);
...
function deleteServicesBrief(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/servicesbrief.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistservicesbrief);
