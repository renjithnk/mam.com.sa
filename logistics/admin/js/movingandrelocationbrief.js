...
function submitMovingAndRelocation()
{
...
var frmaddmovingandrelocationExists = document.getElementById("frmaddmovingandrelocation");
if(frmaddmovingandrelocationExists)
{
		document.getElementById('frmaddmovingandrelocation').onsubmit=function(e){
						e.preventDefault();
						var xhr=new XMLHttpRequest();
						var url="../php/movingandrelocationbrief.php";
						xhr.open('post',url,true);
						var formData=new FormData(frmaddmovingandrelocation);
...
function editMovingAndRelocation(id)
{
	 window.location.href="edit.php?id="+id;
}


function submitUpdateMovingAndRelocation()
{
		document.getElementById("errmsg").innerHTML="";
		document.getElementById("loading").style.display = "none";
		document.getElementById("msgstatus").style.display = "none";
...
var frmeditmovingandrelocationExists = document.getElementById("frmeditmovingandrelocation");
if(frmeditmovingandrelocationExists)
{
		document.getElementById('frmeditmovingandrelocation').onsubmit=function(e){
					e.preventDefault();
					var xhr=new XMLHttpRequest();
					var url="../php/movingandrelocationbrief.php";
					xhr.open('post',url,true);
					var formData=new FormData(frmeditmovingandrelocation);
...
function deleteMovingAndRelocation(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/movingandrelocationbrief.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistmovingandrelocation);
