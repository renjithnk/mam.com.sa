<script>
	CKEDITOR.ClassicEditor.create(document.getElementById("description"), {
        toolbar: {
		    ...
		    extraPlugins: [ 'GeneralHtmlSupport' ], // Enable General HTML Support plugin
            htmlSupport: {
                allow: [
                    {
                        name: 'div',
                        attributes: true, // Allow attributes within div tags
                        classes: true, // Allow classes on div tags
                        styles: true // Allow inline styles on div tags
                    }
                ]
            },
            // Optional: to change the behavior of the 'Enter' and 'Shift+Enter' keys
            enterMode: 'div', // Use <div> when pressing Enter
            shiftEnterMode: 'br', // Use <br> when pressing Shift+Enter
...
var frmaddserviceExists = document.getElementById("frmaddservice");
if(frmaddserviceExists)
{
				document.getElementById('frmaddservice').onsubmit=function(e){
					/*const description = CKEDITOR.instances.description.getData();*/
				//	const description =  document.getElementById("description").innerHTML;
					const description = document.getElementById("description").value;
					const short_description = document.getElementById("short_description").value;
					if((description != "") && (short_description != ""))
					{
							...
							var url="../php/landingpagesservice.php";
							xhr.open('post',url,true);
							var formData=new FormData(frmaddservice);
...
var frmeditserviceExists = document.getElementById("frmeditservice");
if(frmeditserviceExists)
{
		document.getElementById('frmeditservice').onsubmit=function(e){
				//	const description = CKEDITOR.instances.description.getData();
					const description = document.getElementById("description").value;
					const short_description = document.getElementById("short_description").value;
					if((description != "") && (short_description != ""))
					{
									...
									var url="../php/landingpagesservice.php";
									xhr.open('post',url,true);
									var formData=new FormData(frmeditservice);
									formData.append("description", description);
									formData.append("short_description", short_description);
...
function deleteService(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/landingpagesservice.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistservice);
