...
var frmaddmembers_inExists = document.getElementById("frmaddmembers_in");
if(frmaddmembers_inExists)
{
		document.getElementById('frmaddmembers_in').onsubmit=function(e){
						e.preventDefault();
						var xhr=new XMLHttpRequest();
						var url="../php/members_in.php";
						xhr.open('post',url,true);
						var formData=new FormData(frmaddmembers_in);
...
function editMembersIn(id)
{
	 window.location.href="edit.php?id="+id;
}


function submitUpdateMembersIn()
{
		document.getElementById("errmsg").innerHTML="";
		document.getElementById("loading").style.display = "none";
		document.getElementById("msgstatus").style.display = "none";
...
var frmeditmembers_inExists = document.getElementById("frmeditmembers_in");
if(frmeditmembers_inExists)
{
		document.getElementById('frmeditmembers_in').onsubmit=function(e){
					e.preventDefault();
					var xhr=new XMLHttpRequest();
					var url="../php/members_in.php";
					xhr.open('post',url,true);
					var formData=new FormData(frmeditmembers_in);
...
function deleteMembersIn(id)
{
	    ...
	    if(result)
		{
				...
				var url="../php/members_in.php";
				xhr.open('post',url,true);
				var formData=new FormData(frmlistmembers_in);
