...
$db = new Database();
$sql = "SELECT landingpagestestimonial.id,landingpagestestimonial.page_id,landingpagestestimonial.name,landingpagestestimonial.location,landingpagestestimonial.comment,landingpagestestimonial.status, landingpage.pagename,landingpage.status FROM `landingpagestestimonial` inner join landingpage on landingpagestestimonial.page_id=landingpage.id where landingpage.status=0 and landingpagestestimonial.status=0 order by landingpagestestimonial.id desc";
// echo $sql;
$result = $db->query($sql);
?>
