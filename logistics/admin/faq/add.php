...
<div class="admin-main-section dashboard">
		<h1 class="admin-main-section__heading">Add Faq</h1>
		...
		<div class="href_back"><a href="<?php echo $adminPath;?>faq/list.php" class="btn-default">Back</a></div>
					...
					<div id="msg"></div>
<form name="frmaddfaq" id="frmaddfaq" method="post" enctype="multipart/form-data">
	<table style="padding: 0; margin: 0;">
		...
		<tr>
			...
			<button class="form__submit btn1" type="submit" name="btnFaqAdd" id="btnFaqAdd" onclick="submitFaq();">Submit</button></td>
		</tr>
