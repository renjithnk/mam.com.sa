...
$landingPageList = $db->query($sql);
		...
		if(@$id != "")
		{
					$sql = "SELECT * FROM streefreemove where id=$id and status=0";  
					$result = $db->query($sql); 
					$row = $result->fetch_array();
					$imgPath="";
					if(@$row['image'] != "")
					{
						$imgPath=$adminPath . 'uploads/streefreemove/' . @$row['image'];
					}
		}
?>
<div class="admin-main-section dashboard">
		<h1 class="admin-main-section__heading">Edit Stress Free move</h1>
		...
		<div class="href_back"><a href="<?php echo $adminPath;?>streefreemove/list.php" class="btn-default">Back</a></div>
					...
					<div id="msg"></div>
					<form name="frmeditstreefreemove" id="frmeditstreefreemove" method="post" enctype="multipart/form-data">
									...
									<table style="padding: 0; margin: 0;">
										...
										<tr>
											<td colspan="2" class="cls_btn"><input class="form__submit btn1" type="submit" onclick="submitEditStreeFreeMove();" value="Submit" name="btnStreeFreeMoveAdd" id="btnStreeFreeMoveAdd"></td>
										</tr>
