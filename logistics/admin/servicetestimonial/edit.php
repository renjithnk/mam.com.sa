...
if(@$id != "")
{
	$sql = "SELECT * FROM service_pages_testimonial where id=$id";  
	$result = $db->query($sql); 
	$row = $result->fetch_array();
	$imgPath="";
	if(@$row['image'] != "")
	{
		$imgPath=$adminPath . 'uploads/servicetestimonial/' . @$row['image'];
	}
}
...
<div class="admin-main-section dashboard">
		<h1 class="admin-main-section__heading">Edit Service Page Testimonial</h1>
		...
		<div class="href_back"><a href="<?php echo $adminPath;?>servicetestimonial/list.php" class="btn-default">Back</a></div>
					...
					<div id="msg"></div>
						...
						<form name="frmeditservicetestimonial" id="frmeditservicetestimonial" method="post" enctype="multipart/form-data">
							...
							<table style="padding: 0; margin: 0;">
								...
								<tr>	
									...
									<button class="form__submit btn1" type="submit" name="btnupdate" id="btnupdate" onclick="submitEditServiceTestimonial();">Submit</button>
									</td>
								</tr>
							</table>
