...
<script>
// Function to check if the user is on mobile Chrome
const isMobileChrome = /Chrome/i.test(navigator.userAgent) && /Mobi/i.test(navigator.userAgent);

const dateInput = document.getElementById("estimated_date");

// If it's mobile Chrome, set a custom placeholder-like behavior
if (isMobileChrome) {
    dateInput.addEventListener("focus", function() {
        if (dateInput.value === "") {
            dateInput.placeholder = "MM/DD/YYYY"; // Fake placeholder when focused
        }
    });
}
</script>
