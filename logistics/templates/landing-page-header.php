        ...
        <div class="aegis-site-header__container">
            ...
            <div class="request-quote-and-badge-wrapper">
                <div class="request-a-quote-btn">
                    <a href="<?php echo $clientPath . '/request-a-quote.php';?>"
                        class="btn1-text request-a-quote-btn__link">
                        <img src="<?php echo $clientPath . "/assets/images/request-a-quote-icon.svg";?>"
                            alt="request-a-quote-icon" class="request-a-quote-btn__icon">
                        Request A Quote</a>
                </div>
