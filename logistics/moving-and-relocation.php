...
$sql = "SELECT * FROM service where id=1 and status=0";
$db = new Database();
$result = $db->query($sql);
if (@$result->num_rows > 0) {
	$row = $result->fetch_array();
}
$faqSql = "select * from faq where service_id=1 and status=0";
$faqResult = $db->query($faqSql);
?>
<div class="site-content subpage-content moving-and-relocation">
            ...
            <div class="subpage-main-content__col1">
                <div class="subpage-main-content__col1-section">
                    ...
                    <!--<div class="key-features-box">
                        <h2>Our Key Featurees</h2>
                        <div>
                            <div>
                                <h3>Household Goods Moving</h3>
                                <div>
                                    <ul>
                                        <li>Assigning a personalized moving
                                            expert </li>
                                        <li>Free pre-move survey </li>
                                        <li>Transit insurance </li>
                                        <li>Complete the packing and unpacking process </li>
                                        <li>Domestic and international shipping arrangements </li>
                                        <li>Domestic and international services for households and cars </li>
                                        <li>Customs clearance </li>
                                        <li>Professional assistance with all documentation </li>
                                        <li>Covered truck for local transportation </li>
                                        <li>High-quality packing materials </li>
                                    </ul>
                                    <div>
                                        <a href="request-a-quote.php">GET A QUOTE</a>
                                    </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <ul>
                                        <li>Domestic and GCC-wide transportation </li>
                                        <li>Tow truck services </li>
                                        <li>FTL and LTL Transportation </li>
                                        <li>Air, sea, and land freight </li>
                            ...
                            <div>
                                ...
                                <div>
                                    <ul>
                                        ...
                                        <li>Flat space for furniture</li>
                                        <li>Large space for cars and boats</li>
                                        <li>Strong distribution network</li>
                                        <li>On-time and secured delivery services</li>
                                        <li>Safety and security - CCTV, fire alarm, water sprinkler systems</li>
                                        <li>Parking space surrounding the building - For all kinds of vehicles</li>
                                        <li>Loading and offloading- available forklifts and manpower</li>
                                    </ul>
                                    <div>
                                        <a href="request-a-quote.php">GET A QUOTE</a>
                                    </div>
                ...
                <?php
				$landingpagevideoSql = "SELECT * FROM videos where service_id=1 and status=0";
            ...
            <div class="aegis-testimonials__container container-fluid">
                ...
                <div class="swiper2 aegis-testimonials__swiper2">
                    <div class="swiper-wrapper aegis-testimonials__wrapper">
                        <?php
						$sql = "SELECT * FROM service_pages_testimonial where service_id=1 and status=0 order by id desc";
						$result = $db->query($sql);
						if (@$result->num_rows > 0) {
							$sliderPath = "";
