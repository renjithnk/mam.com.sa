...
$sql = "SELECT * FROM pages where sub_menu_id=1 and status=0";
$db = new Database();
$result = $db->query($sql);
...
$subpagesFaqSql="select * from sub_pages_faq where sub_menu_id=1 and status=0";
...
<div class="site-content subpage-content movers-in-al-bustan">
    ...
    <div class="site-content__section subpage-main-content">
        ...
        <?php
			$videoSql = "SELECT * FROM sub_pages_videos where sub_menu_id=1 and status=0";
            ...
            <div class="aegis-testimonials__container container-fluid">
                ...
                <div class="swiper2 aegis-testimonials__swiper2">
                    <div class="swiper-wrapper aegis-testimonials__wrapper">
                        <?php
				$sql = "SELECT * FROM  sub_pages_testimonial where sub_menu_id=1 and status=0 order by id desc";
				$result = $db->query($sql);
				if(@$result->num_rows > 0) 
				{
						$sliderPath="";
