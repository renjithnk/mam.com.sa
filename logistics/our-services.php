...
$sql = "SELECT * FROM ourservice where id=1 and status=0";
$db = new Database();
$result = $db->query($sql);
...
<div class="site-content subpage-content about-us">
    <div class="site-content__section subpage-banner">
        <img src="<?php echo $clientPath . "/admin/uploads/ourservice/" . $row['image']; ?>"
        ...
        <div class="subpage-content__section subpage-main-content__double-column-container container-fluid">
		 ...
		 echo $row['description'];?>
            ...
            <div class="subpage-main-content__col2">
                <img src="<?php echo $clientPath . "/admin/uploads/ourservice/" . $row['ads_image']; ?>"
                    alt="<?php echo $row['ads_image_alt'];?>">
            </div>
        </div>
    </div>
