<div class="landing-page-form">
    ...
    <form class="form landing-page-form__form-tag" method="post" name="frminternationalmovers" id="frminternationalmovers">
...
<!--    <div class="g-recaptcha" data-sitekey="6Ld9RLwqAAAAAJdtendBJXvo6WjFoV5GLIIfbScA"></div>  -->
        ...
        <div class="form__submit-wrapper">
            <button class="form__submit btn1" type="submit" name="btnsend" id="btnsend"
                onclick="submitInternationalmovers();">Submit</button>
        </div>
