...
$sql = "SELECT * FROM service where id=12 and status=0";
$db = new Database();
$result = $db->query($sql);
...
$faqSql="select * from faq where service_id=12 and status=0";
...
<div class="site-content subpage-content about-us">
    ...
    <div class="site-content__section subpage-main-content">
        <div class="subpage-content__section subpage-main-content__double-column-container">
		  ...
		  echo $row['description'];?>
                ...
                <?php
			$landingpagevideoSql = "SELECT * FROM videos where service_id=12 and status=0";
  ...
  <div class="swiper2 aegis-testimonials__swiper2">
    <div class="swiper-wrapper aegis-testimonials__wrapper">
		<?php
			/*	$sql = "SELECT * FROM service_pages_testimonial where service_id=12 and status=0 order by id desc";
				$result = $db->query($sql);
				if(@$result->num_rows > 0) 
				{
						$sliderPath="";
			   ...
			   ?>
								...
								<img class="aegis-testimonials__quote" src="../logistics/assets/images/testimonials-quote.svg" width="67" height="41" alt="testimonials-quote"  loading="lazy">
								 <?php
