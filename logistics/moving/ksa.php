...
include("../templates/landing-page-header.php");
$db = new Database();
?>
...
<div class="site-content subpage-content landing-page">
    ...
    <div class="site-content__section landing-page-banner">
        ...
        <?php
  	$landingpagesliderSql = "SELECT * FROM landingpageslider where page_id=1 and status=0";
...
if (@$landingpagesliderResult->num_rows > 0) 
{
			 ...
			 {
			 ?>
        <img src="<?php echo $clientPath . "/admin/uploads/landingpageslider/" . $landingpagesliderRow['image']; ?>"
            alt="<?php echo $landingpagesliderRow['alt'];?>" class="landing-page-banner__img">
...
?>
    ...
    <div class="site-content__section landing-page-services no-padding-bottom">
        <div class="landing-page-services__container container">
            ...
            <div class="landing-page-services__items-container">
                ...
                <?php
	$serviceSql = "SELECT * FROM landingpagesservice where page_id=1 and status=0";
	...
	?>
                <div class="landing-page-services__items">
                    ...
                    <img src="<?php echo $clientPath . "/admin/uploads/service/" . $serviceRow['image']; ?>"
                        alt="<?php echo $serviceRow['alt'];?>" class="landing-page-services__image" width="350"
                        height="130">
	...
	?>
        ...
        <?php
$whychooseusSql = "SELECT * FROM whychooseus where page_id=1 and status=0";
$db = new Database();
...
?>
	...
	?>
                <div class="why-choose-us__items">
                    <img src="<?php echo $clientPath . "/admin/uploads/whychooseus/" . $whychooseuseRow['image']; ?>"
                        alt="<?php echo $whychooseuseRow['alt'];?>" class="why-choose-us__images" width="52"
                        height="47">
    ...
    <?php
$streefreemoveSql = "SELECT * FROM streefreemove where page_id=1 and status=0";
$db = new Database();
        ...
        <div class="stress-free-move__container container">
            ...
            <div class="stress-free-move__items-container">
                ...
                <div class="stress-free-move__items">
                    <img src="<?php echo $clientPath . "/admin/uploads/streefreemove/" . $streefreemoveRow['image']; ?>"
                        alt="<?php echo $streefreemoveRow['alt'];?>" class="stress-free-move__items-icon">
        ...
        <div class="aegis-testimonials__container container">
            ...
            <div class="swiper2 aegis-testimonials__swiper2">
                <div class="swiper-wrapper aegis-testimonials__wrapper">
                    <?php
				$sql = "SELECT * FROM landingpagestestimonial where page_id=1 and status=0 order by id desc";
				$result = $db->query($sql);
			   ...
			   ?>
                    <div class="swiper-slide aegis-testimonials__slide">
                        <img class="aegis-testimonials__quote"
                            src="<?php echo $clientPath . "/assets/images/testimonials-quote.svg"; ?>" width="67"
                            height="41" alt="testimonials-quote" loading="lazy">
...
?>
    ...
    <div class="site-content__section leave-review no-padding-top">
        <a href="<?php echo $aegis_settingsResultRow['google_review_link']; ?>" target='_blank'
            class="leave-review__link">
            <img src="<?php echo $clientPath . "/assets/images/leave-review-button.svg"; ?>" alt=""
                class="leave-review__image"></a>
    </div>

    <div class="site-content__section get-free-quote-button no-padding-top">
        <a href="#top" class="get-free-quote-button__link">Get A Free Quote<img
                src="<?php echo $clientPath . "/assets/images/get-a-quote-icon.svg"; ?>" alt="Get a Quote"
                class="get-free-quote-button__icon"></a>
    </div>
    ...
    <div class="site-content__section video no-padding-top">
        <iframe width="" height="" src="<?php echo $landingpagevideoResultRow['video_url'];?>" frameborder="0"
                ...
                <div class="aegis-member-box">
                    ...
                    <div class="aegis-member-box__row2">
                        ...
                        <div class="aegis-member-box__col2">
                            <img src="../assets/images/iam-logo.svg" class="aegis-member-box__logo" width="224"
                                height="74" loading="lazy">
                        </div>
                        <div class="aegis-member-box__col3">
                            <img src="../assets/images/global-logistics-alliance-logo.webp"
                                class="aegis-member-box__logo" width="224" height="74" loading="lazy">
                        </div>
                    </div>
